...
Item {
    ...
    readonly property var shortcuts: [
        ...
        { keys: "Ctrl+Tab / Ctrl+Shift+L", action: I18n.tr("Next tab") },
        { keys: "Ctrl+Shift+H", action: I18n.tr("Previous tab") },
    ...
    Rectangle {
        ...
        // Cap the card at the window so a small terminal never pushes the
        // content outside; the scroll area below handles overflow.
        ...
        DankFlickable {
            ...
            anchors.margins: 18
            clip: true
            // Keyboard focus follows the overlay; scrollbars stay usable.
            interactive: contentColumn.height > helpFlick.height
            ...
            Column {
                ...
                Repeater {
                    ...
                    Row {
                        ...
                        StyledText {
                            width: parent.width - keyText.width - parent.spacing
